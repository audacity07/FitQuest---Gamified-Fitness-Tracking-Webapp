    ...
    <div>
      ...
      <section className="bg-[#EFEFEF] py-20">
        <div className="w-[82%] m-auto">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-40">
            <div>
              <h1 className="text-6xl font-extrabold text-slate-700 font-sans2">
                Gamify your <br />
                fitness
              </h1>
              <p className="text-xl text-zinc-600 font-[rubik] mt-5 lg:mt-7">
                Track your workouts to level up your avatars and climb
                leaderboards!
              </p>
            </div>
                  ...
                  <div className="w-full">
                    ...
                    >
                      ...
                      <div
                        ...
                        className={`absolute bg-red-500 h-[20px] -z-10 rounded-full -ml-2 transition-all duration-700`}
                      ></div>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-20 pt-40 bg-[#EFEFEF]">
        <div className="text-center">
          ...
          <p className="font-[rubik] text-xl text-zinc-600 px-5">
      ...
      <section className="bg-[#EFEFEF] py-20 px-5">
        <div>
          <div className="flex flex-col md:flex-row items-center justify-center gap-12">
            <div className="">
              <video
                className="rounded-2xl border border-gray-300 w-96"
                src={featureVideo}
                autoPlay
                muted
                loop
            ...
            <div className="md:w-[45%] lg:w-[32%]">
              <h3 className="font-[rubik] text-orange-600 text-lg font-semibold">
                GAMIFICATION
              </h3>
              <h1 className="font-[rubik] text-slate-700 text-4xl font-bold my-7">
                Make workouts fun
              </h1>
              <p className="font-[rubik] text-zinc-500">
                Choose your workout avatars 🧘 amongst 37 characters. Track your
                progress to gain XP and level them up!
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-12 my-20">
            ...
            <div className="md:w-[45%] lg:w-[32%]">
              ...
              <p className="font-[rubik] text-zinc-500">
                ...
                shrinks...
                <br />A good reason to put on your workout shoes!
              </p>
            </div>
          </div>
      ...
      <section id="register" className="text-center py-20 bg-[#EFEFEF] px-5">
        <h1 className="text-5xl text-slate-700 font-bold font-[rubik]">
          You're a hero!
        </h1>
        <div className="mt-10 bg-white inline-block py-5 w-full md:w-[700px] rounded-3xl">
          <p className="text-lg text-zinc-600 px-3">
            Sign up for free and grow your avatar!
          </p>
          <div className="mt-10 mb-2">
            <Link
              to={"/register"}
              className="text-white bg-orange-600 rounded py-3 px-3 font-[rubik] font-medium"
            >
              GET MY AVATAR NOW
            </Link>
          </div>
