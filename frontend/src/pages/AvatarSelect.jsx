...
export const AvatarSelect = () => {
    ...
    // const seletectedActivities = useSelector((store) => store.selectedActivityReducer);
    ...
    const handleSubmitAvatar = () => {
        dispatch(postSelectedActivity(selectAvatar))
    }
    const toggleMenu = () => {
        setOpen(prev => !prev)
    }
    ...
    return (
        <div className='bg-[#EFEFEF] py-5 pb-28'>
            <section className='flex justify-center items-start gap-10 '>
                ...
                <div div className={`w-[490px] ${allActivities.length < 2 && "h-[80vh]"} flex flex-col gap-5 justify-center items-center`}>
                        ...
                        <div>
                            {
                                ...
                                allActivities?.map((activitie) => (
                                    <div className='mt-5' key={activitie._id}>
                                        <ActivityCard {...activitie} />
                                    </div>
                                ))
                            }
                        </div>
