          ...
          <div className="w-[70%] m-auto py-5">
            <div className="w-[95%] m-auto">
              <div className="shadow-[0px_2px_8px_0px_rgba(99,99,99,0.2)] bg-white py-3 rounded-2xl flex items-center justify-between px-4">
                <p className="py-2  text-xl font-[rubik] text-slate-600">
                  S.No
                </p>
                <p className=" text-xl font-[rubik] text-slate-600">
                  User Name
                </p>
              ...
              <div className="text-center mt-4">
                {sport === "" &&
                  AllUsers?.map((user, i) => (
                    <div
                      key={user._id}
                      className={`w-full flex justify-between items-center my-4 shadow-[0px_2px_8px_0px_rgba(99,99,99,0.2)] bg-white py-1 rounded-2xl px-6`}
                    >
