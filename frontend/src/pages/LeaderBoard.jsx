              ...
              <div className="text-center flex items-center justify-center">
                <div className="bg-white  min-w-full md:w-[90%] lg:w-[1000px] max-[425px]:overflow-scroll rounded-md py-3 px-3 shadow-[0px_8px_24px_rgba(149,157,165,0.2)]">
                  <table className="w-full text-center">
                    <thead>
                      <tr>
                        <th className="font-sans1 px-4 py-3 font-extrabold text-zinc-600 bg-[#faf5f4] rounded-md border-r-4 border-white">
                          S.No
                        </th>
                        <th className="font-sans1 px-4 py-3 font-extrabold text-zinc-600 bg-[#faf5f4] rounded-md border-r-4 border-white">
                          User Name
                              ...
                              <button
                                ...
                                className={` font-semibold py-2 ${
                                  userData._id === item._id
                                    ? "bg-black/30 text-white cursor-not-allowed font-sans1"
