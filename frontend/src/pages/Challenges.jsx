  ...
  return (
    <>
      ...
      <div className="mt-28 flex justify-center items-center">
        <div className="w-[40%]">
          <h1 className="text-4xl text-slate-700 font-bold mb-10 text-center font-[rubik]">
            Create Challenges
          </h1>
          ...
          <div>
            <h1 className="text-3xl font-bold font-[rubik] text-center">
              Challenges
            </h1>
            <div className="flex flex-col gap-5 justify-center items-center mt-5">
              {challenges.length > 0 &&
                challenges?.map((challenge) => (
                  <div
                    key={challenge._id}
                    className="bg-white w-[400px] p-2 px-5 rounded-xl"
                  >
                    <div className="flex items-center gap-5">
                      <div className="text-6xl">🏆</div>
                      <div>
                        <p className="text-lg font-semibold text-slate-700 font-[rubik]">
                        ...
                        <ul className="text-lg font-normal text-slate-400 font-[rubik]">
                          ...
                          {challenge?.participants?.map((item) => (
                            <li
                              key={item._id}
                              className="list-disc ml-10 font-medium text-slate-700"
                            >
                              {item.username}
                            </li>
                          ))}
