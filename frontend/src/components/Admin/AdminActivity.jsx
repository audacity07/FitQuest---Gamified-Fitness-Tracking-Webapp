...
function AdminActivity() {
  ...
  const getImojiFun = async () => {
    try {
      let res = await fetch(`${process.env.REACT_APP_API_URL}/activity`, {
        method: "GET",
        headers: {
    ...
    <>
      <div>
        <div className="fixed w-[22%] h-screen bg-white pt-10 pl-10 shadow-[0px_8px_24px_rgba(149,157,165,0.2)]">
          <p className="font-[rubic] font-semibold text-xl text-slate-600">
            FitQuest
          </p>
          <div className="flex items-center w-[90%] mt-10 gap-5 bg-[#EEEFF1] rounded-xl pl-2 py-3">
            ...
            <p className="text-[1rem] font-semibold font-[rubik]">
              Hello, Admin
            </p>
          </div>
        ...
        <div className="w-[70%] ml-96">
          ...
          <div className="overflow-x-auto bg-white px-3 rounded-lg shadow-[0px_8px_24px_rgba(149,157,165,0.2)]">
            <table className="min-w-full table-auto mt-3">
              <thead>
                <tr className="">
                  <th className="font-[rubik] px-4 py-3 text-left text-zinc-600 bg-[#faf5f4] rounded-md border-r-4 border-white">
                    Name
                  </th>
                  <th className="font-[rubik] px-4 py-3 text-center text-zinc-600 bg-[#faf5f4] rounded-md border-r-4 border-white">
                    Emoji
                  </th>
                  <th className="font-[rubik] px-4 py-3 text-center text-zinc-600 bg-[#faf5f4] rounded-md border-r-4 border-white">
                    Edit
                  </th>
                  <th className="font-[rubik] px-4 py-3 text-center text-zinc-600 bg-[#faf5f4] rounded-md">
                    Delete
                  </th>
                </tr>
              </thead>
